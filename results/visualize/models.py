...
oracle = [978, 972, 943, 904, 917]
fcfs = [936, 693, 693, 335, 335]
deadline = [908, 677, 640, 329, 335]
random = [941, 754, 719, 337, 355]
bidding = [961, 840, 819, 467, 557]
...
plt.title('Performance Comparison of Different Scheduling Policies for Batching Requests', fontsize=16)
...
plt.tight_layout()
plt.grid()
plt.savefig("goodput_comparison_models.png")