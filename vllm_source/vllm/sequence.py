...
class RequestMetrics:
    ...
    def __post_init__(self):
        ...
        if self.workload_type == "search":
            self.deadline = self.arrival_time + random.uniform(0.5, 1)
            self.tokens = 10
        elif self.workload_type == "chatbox":
            self.tokens = 50
            self.deadline = self.arrival_time + (self.tokens * 0.2)
...
class SequenceGroup:
    ...
    def __init__(
        ...
        self.metrics = RequestMetrics(arrival_time=arrival_time,
                                      ...
                                      time_in_queue=None)
        self.sampling_params.max_tokens = self.metrics.tokens
        self.sampling_params.min_tokens = self.metrics.tokens
        self.lora_request = lora_request
